...
public class HashRingTest {
    ...
    public void testConsistentHashing() {
        ...
        assertEquals(List.of(node2, node4, node6, node0), hashRing.getNodes(0, 4));
        assertEquals(List.of(node2, node4, node6, node0), hashRing.getNodes(1, 4));
        assertEquals(List.of(node4, node6, node0, node2), hashRing.getNodes(2, 4));
        assertEquals(List.of(node0, node2, node4, node6), hashRing.getNodes(7, 4));
    }
    ...
    public void testSubscribeAndRebalancing() {
        ...
        Node node0Get = hashRing.getNode(0);
        assertEquals(node2, node0Get);
        Node node2Get = hashRing.getNode(2);
        assertEquals(node4, node2Get);
        Node node4Get = hashRing.getNode(4);
        assertEquals(node6, node4Get);
        Node node6Get = hashRing.getNode(6);
        ...
        Node node0GetBis = hashRing.getNode(0);
        Node node2GetBis = hashRing.getNode(2);
        Node node4GetBis = hashRing.getNode(4);
        Node node6GetBis = hashRing.getNode(6);
        Node node7Get = hashRing.getNode(7);
    ...
    public void testReplicatedNodes() {
        ...
        Node node0Get = hashRing.getNode(0);
        Node node1Get = hashRing.getNode(1);
        Node node2Get = hashRing.getNode(2);
        Node node3Get = hashRing.getNode(3);
